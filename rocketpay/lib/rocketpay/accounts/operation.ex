defmodule Rocketpay.Accounts.Operation do
  ...
  def call(%{"id" => id, "value" => value}, operation) do
    ...
    Multi.new()
    |> Multi.run(operation_name, fn repo, _changes -> read_account(repo, id) end)
  ...
  defp update_balance(repo, account, value, operation) do
    account
    |> calculate_values(value, operation)
    |> update_account(repo, account)
  end

  defp calculate_values(%Account{balance: balance}, value, operation) do
    value
    |> Decimal.cast()
